...
// Menu
// ================================================================================================================
export function ReactkutMenu({ githubUser }) {
  const [isMenuOpen, setMenuState] = React.useState(false);
  return (
    <ReactkutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <ReactkutMenu.Logo src={`${BASE_URL}/logo.svg`} />
    ...
    </ReactkutMenu.Wrapper>
  )
}
ReactkutMenu.Wrapper = styled.header`
  width: 100%;
